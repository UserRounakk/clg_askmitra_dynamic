...
window.onload = (e)=>{
    ...
    resourceUl.querySelectorAll("li")[0].classList.replace("tab-secondary", "text-bg-primary")
    resourceUl.querySelectorAll("button")[0].classList.replace("text-black","active")
