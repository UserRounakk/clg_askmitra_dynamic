...
!(function (t, r) {
        ...
        w =
            ...
            (yi.extension = function (n, t, r) {
                var e = mi.type(n) == _t,
                    i = arguments[gi.l],
                    o = 0;
                if (i < 1 || !e) return Si.extend(!0, { length: y[gi.l] }, y);
                if (e)
                    if (mi.type(t) == wt)
                        y.push({
                            name: n,
                ...
                if (0 < d[v] && p) {
                    ...
                    if (b < u) {
                        ...
                        for (var f = 0; f < d[v]; f++)
                            (t = d[f]) !== bi &&
                                ((e = (r = t.options())[s]),
                                (i = xi.max(1, r.autoUpdateInterval)),
                                (o = l()),
                                (!0 === e || null === e) &&
                                    o - h[f] > i &&
                                    (t.update("auto"),
                                    (h[f] = new Date((o += i)))),
                                (n = xi.max(1, xi.min(n, i))));
                        b = n;
                    }
                } else b = 33;
            };
    ...
    function z(r, n, t, kt, Ot) {
        ...
        if (lt(r)) {
            ...
            return (
                    ...
                    if (!Mt) {
                        ...
                        return (
                            a
                                ...
                                : ((n = Kt || n),
                                  (Kt = !1),
                                  (Ct.update(hn) && !n) || ni({ A: n })),
                            Et ||
                                or.find("img").each(function (n, t) {
                                    -1 === mi.inA(t, Pn) &&
                                        Si(t).off("load", nt).on("load", nt);
                                }),
                            e || i || o
                        );
                    }
                ...
                (Ct.scroll = function (n, t, r, e) {
                    if (0 === arguments.length || n === bi) {
                        ...
                        return (
                            ...
                            (f *= o ? -1 : 1),
                            {
                                position: { x: (a *= o ? -1 : 1), y: dn.H },
                                ratio: { x: u, y: dn.N },
                                max: { x: f, y: dn.R },
                                handleOffset: { x: vn.L, y: dn.L },
                                handleLength: { x: vn.W, y: dn.W },
                                handleLengthRatio: { x: vn.D, y: dn.D },
                                trackLength: { x: vn.I, y: dn.I },
                                snappedHandleOffset: { x: vn.M, y: dn.M },
                                isRTL: $t,
                                isRTLNormalized: Ur,
                            }
                        );
                    ...
                    (z[Ae] = U(!0, P(!0, n))),
                        ...
                        (l || s) && (0 < t || _)
                            ? _
                                ? ((t.complete = j), ir.animate(z, t))
                                : ((v = { duration: t, complete: j }),
                                  cn(r) == xt || Si.isPlainObject(r)
                                      ? ((T[Ae] = r[0] || r.x),
                                        (T[He] = r[1] || r.y),
                                        (v.specialEasing = T))
                                      : (v.easing = r),
                                  ir.animate(z, v))
                            : (l && ir[Ae](z[Ae]), s && ir[He](z[He]), E());
                }),
                    ...
                    if (cn(n) == _t) {
                        if (Fn[gi.hOP](n))
                            for (t = di({}, Fn[n]); e < r.length; e++)
                                delete t[r[e]];
                    } else for (e in ((t = {}), Fn)) t[e] = di({}, Ct.ext(e));
                    return t;
                }),
                ...
                (Ct.removeExt = function (n) {
                    ...
                    return (
                        !!r &&
                        (delete Fn[n], (t = r.removed), cn(t) == wt && t(), !0)
                    );
                }),
                yi.valid(
                    (function bt(n, t, r) {
                        ...
                        return (
                            ...
                            (Dt = di({}, kt.nativeScrollbarSize)),
                            (At = di({}, kt.nativeScrollbarIsOverlaid)),
                            (Ht = di({}, kt.overlayScrollbarDummySize)),
                            (Nt = di({}, kt.rtlScrollBehavior)),
                            et(di({}, o, t)),
                            (Wt = kt.cssCalc),
                            (D = kt.msie),
                            (Rt = kt.autoUpdateRecommended),
                            (I = kt.supportTransition),
                            (sn = kt.supportTransform),
                            (m = kt.supportPassiveEvents),
                            (A = kt.supportResizeObserver),
                            (s = kt.supportMutationObserver),
                            kt.restrictedMeasuring,
                            (M = Si(n.ownerDocument)),
                            (H = M[0]),
                            (u = Si(H.defaultView || H.parentWindow)),
                            (w = u[0]),
                            (d = pt(M, "html")),
                            (E = pt(d, "body")),
                            (Zt = Si(n)),
                            ...
                            (y = H !== mt),
                            (v = Et
                                ? Zt.hasClass(fn) && Zt.parent().hasClass(xn)
                                : Zt.hasClass(rn) && Zt.children(W + mn)[gi.l]),
                            At.x &&
                            At.y &&
                            !Gt.nativeScrollbarsOverlaid.initialize
                                ? (ui("onInitializationWithdrawn"),
                                  v && (it(!0), at(!0), ft(!0)),
                                  (Kt = Mt = !0))
                                : (jt &&
                                      (((e = {}).l = xi.max(
                                  ...
                                  (function l() {
                                      ...
                                      Yn(cr, B, function (n) {
                                          f(n) &&
                                              ...
                                              (Qr && ((r = !0), Ge()),
                                              (e = c(n)),
                                              (i.w = sr[gi.oW] - (Ft ? 0 : Ut)),
                                              (i.h = sr[gi.oH] - (Ft ? 0 : qt)),
                                              (o = ct()),
                                              Xn(M, [J, X, V], [Zn, a, u]),
                                              hi(E, In),
        ...
        function Xn(n, t, r, e, i) {
            var o = cn(t) == xt && cn(r) == xt,
                ...
                f = !o && t.split(Ce),
                c = 0;
            if (o) for (; c < t[gi.l]; c++) Xn(n, t[c], r[c], e);
            else
                for (; c < f[gi.l]; c++)
                ...
                if (t) {
                    if (A)
                        ((O = n
                            .addClass("observed")
                            .append(si(_n))
                            .contents()[0])[Z] = new r(a)).observe(O);
                    else if (9 < D || !Rt) {
                        n.prepend(
                            si(
                                _n,
                        ...
                        if (S)
                            n.prepend(si(_n)),
                                pt(n, W + _n)[0].attachEvent("onresize", a);
                        else {
                            var T = H.createElement(yt);
                            T.setAttribute(gi.ti, "-1"),
                                T.setAttribute(gi.c, _n),
                                (T.onload = function () {
        ...
        function Je(n) {
            Xn(nr, X, Qn, !ee || n, !0),
                Xn(nr, [Y, $], [Gn, Jn], !!ee || n, !0),
                It || n || nr.one("mouseover", Gn);
        }
        function Qe() {
            var n = {};
            return (
        ...
        function Ze() {
            if (!Kt) {
                ...
                return (
                    ...
                    Zt.css(u),
                    (n = lr[gi.oW]),
                    (t = f ? xi.max(n, lr[gi.sW] - 1) : 1),
                    (u[xe] = xr ? Te : Oe),
                    (u[ye + xe] = Oe),
                    (u[_e] = Te),
                    Zt.css(u),
                    (r = lr[gi.oH]),
                    (e = xi.max(r, lr[gi.sH] - 1)),
                    (u[xe] = t),
                    (u[_e] = e),
                    fr.css(u),
                    (u[ye + xe] = o),
        ...
        function ni(n) {
            ...
            if (
                ...
                if (
                    ...
                    (hn.ih = ci(hn.h)),
                    (hn.iw = ci(hn.w)),
                    (hn.ch = -1 < hn.h.indexOf("px")),
                    (hn.cw = -1 < hn.w.indexOf("px")),
                    (hn.c = f(hn, Sr)),
                    (Jr = t),
                    (Vr = U),
                    (Cr = B),
                ...
                var Sn = !!Et && Ze(),
                    ...
                    Tn =
                        Et && Sn
                            ? { w: I ? Sn.B : Sn.U, h: E ? Sn.V : Sn.q }
                            : {};
                if (
                    ((Yr = Sn),
                    an && (un || T || Y || hn.c || $.c || vn.c)
                        ? (pn[_e] = Te)
                        : (un || T) && ((pn[we + _e] = ze), (pn[_e] = Oe)),
                    rn && (en || T || Y || hn.c || $.c || vn.c || V)
                        ? ((pn[xe] = Te), (bn[we + xe] = Oe))
                        : (en || T) &&
                          ((pn[we + xe] = ze),
                          (pn[xe] = Oe),
                          (pn[Se] = ze),
                        ...
                        var En = {},
                            jn = function (n) {
                                ...
                                (i && (i || !vn.c)) ||
                                    ...
                                    !(i && Ln[r] < le[r]) ||
                                        (n && Et && U) ||
                                        (Et && (En[e] = ci(fr.css(e)) - 1),
                                        --bn[e]),
                                    0 < Ln[r] && (bn[e] = xi.max(1, bn[e]));
                            };
                    ...
                    var Pn = Et && (0 === le.w || 0 === le.h),
                        ...
                        Jn = function (n) {
                            ...
                            (qn[e] = "v-s" === W[e]),
                                ...
                                (Xn[e] = xi.max(
                                    0,
                                    xi.round(100 * (Fn[i] - le[i])) / 100
                                )),
                                (Xn[e] *= Pn || (f && 0 < u && u < 1) ? 0 : 1),
                                (Yn[e] = 0 < Xn[e]),
                                ($n[e] =
                                    qn[e] || Bn[e]
                                        ? Yn[r] && !qn[r] && !Bn[r]
                    ...
                    if (
                        ...
                        var Qn,
                            ...
                            tt = o;
                        (Yn.x || Yn.y) &&
                            ((nt.w = At.y && Yn.y ? Fn.w + Ht.y : ze),
                            (nt.h = At.x && Yn.x ? Fn.h + Ht.x : ze),
                            (tt = f(nt, mr)),
                            (mr = nt)),
                            (Yn.c ||
                                $n.c ||
                                ...
                                Lt ? (H ? pi : hi)(ir, Me) : (Qn(!0), Qn(!1))),
                            H && ((nt.w = nt.h = ze), (tt = !0)),
                            tt &&
                                !Lt &&
                                ((Zn[xe] = $n.y ? nt.w : ze),
                                (Zn[_e] = $n.x ? nt.h : ze),
                                ar || ((ar = Si(si(Ee))), ir.prepend(ar)),
                                ar.css(Zn)),
                            or.css(pn);
                    }
                    var rt,
                    ...
                    if (
                            ...
                            Yn[e] && $n[e + "s"]
                                ? ((et[kn + i] = ke),
                                  H || Lt
                                      ? a()
                                      : ((et[o] = -(At[e] ? Ht[e] : Dt[e])),
                                        (ce[r.j] = At[e] ? Ht[r.P] : 0)))
                                : ((et[kn + i] = ze), a());
                        })(!0),
                        rt(!1),
                        !Lt &&
                        (le.h < se.x || le.w < se.y) &&
                        ((Yn.x && $n.x && !At.x) || (Yn.y && $n.y && !At.y))
                            ? ((et[de + pe] = se.x),
                              (et[ve + pe] = -se.x),
                              (et[de + G] = se.y),
                              (et[ve + G] = -se.y))
                            : (et[de + pe] =
                                  ...
                                  et[ve + G] =
                                      ze),
                        (et[de + K] = et[ve + K] = ze),
                        (Yn.x && $n.x) || (Yn.y && $n.y) || Pn
                            ? Et && Pn && (xn[On] = xn[Cn] = "hidden")
                            : (!k || Bn.x || qn.x || Bn.y || qn.y) &&
                              (Et && (xn[On] = xn[Cn] = ze),
                              (et[On] = et[Cn] = "visible")),
                        er.css(xn),
                        ir.css(et),
                        (et = {}),
                        (Yn.c || Y || en || un) && (!At.x || !At.y))
                    ) {
                        var it = pr[gi.s];
                        (it.webkitTransform = "scale(1)"),
                            ...
                            pr[gi.oH],
                            (it.display = ze),
                            (it.webkitTransform = ze);
                    }
                    if (((pn = {}), V || en || un))
                        if ($t && rn) {
                            var ot = or.css(Se),
                                at = xi.round(
                                    or.css(Se, ze).css(me, ze).position().left
                                );
                            or.css(Se, ot),
                                at !== xi.round(or.position().left) &&
                                    (pn[me] = at);
                        } else pn[me] = ze;
                    if ((or.css(pn), Et && i)) {
                        var ut = (function Tt() {
                    ...
                    $t && Nt.i && At.y && Yn.x && Ur && (c.x += ce.w || 0),
                        rn && nr[Ae](0),
                        an && nr[He](0),
                        ir[Ae](c.x)[He](c.y);
                    var gt = "v" === v,
                    ...
                    ($n.x || $n.y ? hi : pi)(nr, We),
                        ...
                        (p || N) &&
                            (ie || ee ? (Je(!0), Je()) : Je(!0),
                            te ? ri(!0) : ri(!1, !0)),
                        (e || Xn.c || un || en || S || Y || T || N || V) &&
                            (ei(!0), ii(!0), ei(!1), ii(!1)),
                        g && oi(!0, b),
                        y && oi(!1, m),
                        V && ui("onDirectionChanged", { isRTL: $t, dir: B }),
                        e &&
                            ui("onHostSizeChanged", {
                                width: br.w,
                                height: br.h,
                            }),
                        i &&
                            ui("onContentSizeChanged", {
                                width: gr.w,
                                height: gr.h,
                            }),
                        (Yn.c || $n.c) &&
                            ui("onOverflowChanged", {
                                x: Yn.x,
                                y: Yn.y,
                                xScrollable: $n.xs,
                                yScrollable: $n.ys,
                        ...
                        Xn.c &&
                            ui("onOverflowAmountChanged", { x: Xn.x, y: Xn.y });
                }
                jt &&
                    Gr &&
                    (yr.c || Gr.c) &&
                    (Gr.f || Qe(),
                    At.y && yr.x && or.css(ye + xe, Gr.w + Ht.y),
                    At.x && yr.y && or.css(ye + _e, Gr.h + Ht.x),
                    (Gr.c = !1)),
                    ui("onUpdated", { forced: o });
            }
        }
        function et(n) {
        ...
        function it(e) {
            var n = "parent",
                ...
                f = {};
            (nr = nr || (Et ? (v ? Zt[n]()[n]()[n]()[n]() : Si(si(en))) : Zt)),
                (or = or || vt(xn + r)),
                (ir = ir || vt(yn + r)),
                (er = er || vt(mn + r)),
                ...
                e
                    ? (v && It
                          ? (rr.children().remove(),
                            c([er, ir, or, fr], function (n, t) {
                                t && pi(t.removeAttr(gi.s), Mn);
                            }),
                            hi(nr, Et ? en : rn))
                          : (ht(rr),
                            or.contents().unwrap().unwrap().unwrap(),
                            Et && (Zt.unwrap(), ht(nr), ht(fr), a())),
                      Et && Zt.removeAttr(gi.s),
                      jt && pi(d, tn))
                    : (Et &&
                          (Gt.sizeAutoCapable ||
                              ((f[xe] = Zt.css(xe)), (f[_e] = Zt.css(_e))),
                          v || Zt.addClass(Tn).wrap(nr),
                          (nr = Zt[n]().css(f))),
                      v ||
                          (hi(Zt, Et ? t : rn),
                          nr
        ...
        function ut(_) {
            ...
            function R(n) {
                if (
                    ...
                    s(),
                    S !== (z = i = bi) &&
                        (Ct.scrollStop(), clearTimeout(S), (S = bi)),
                    n)
                ) {
                    var t = sr[gi.bCR]();
                    (n.clientX >= t.left &&
        ...
        function ei(n) {
            ...
            (t[r.X] = xi.floor(100 * i * 1e6) / 1e6 + "%"),
                st() || r["in"].css(t),
                (e.W = r["in"][0]["offset" + r.un]),
                (e.D = i);
        }
        function ii(n, t) {
            var r,
    ...
    return (
        _i &&
            _i.fn &&
            (_i.fn.overlayScrollbars = function (n, t) {
                return _i.isPlainObject(n)
                    ? (_i.each(this, function () {
                          w(this, n, t);
                      }),
                      this)
                    : w(this, n);
