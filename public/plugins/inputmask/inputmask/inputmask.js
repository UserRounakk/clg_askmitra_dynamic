    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        var getMaskTemplate = function (
            ...
            do {
                if (baseOnInput === true && getMaskSet().validPositions[pos]) {
                    testPos =
                        clearOptionalTail &&
                        getMaskSet().validPositions[pos].match.optionality ===
                            true &&
                        getMaskSet().validPositions[pos + 1] === undefined &&
                        (getMaskSet().validPositions[pos].generatedInput ===
                            true ||
        ...
        function alternate(pos, c, strict, fromSetValid, rAltPos) {
            var validPsClone = $.extend(true, {}, getMaskSet().validPositions),
                ...
                decisionPos,
                lAltPos =
                    rAltPos !== undefined ? rAltPos : getLastValidPosition();
                ...
                $.each(getTests(position), function (ndx, tst) {
                    ...
                    rslt =
                        test.fn != null
                            ...
                            ? {
                                  c:
                                      getPlaceholder(position, test, true) ||
                                      test.def,
                                  pos: position,
                              }
                            : false;
            ...
            for (var ps = originalPos; ps < newPos; ps++) {
                if (
                    ...
                    if (vp) {
                        ...
                        if (fillOnly !== true) {
                            var cvpInput =
                                getMaskSet().validPositions[newPos].input;
                ...
                if (
                    ...
                    if (k) {
                        ...
                        if (opts._radixDance && opts.numericInput) {
                            var caretPos =
                                getBuffer().indexOf(opts.radixPoint.charAt(0)) +
                                1;
