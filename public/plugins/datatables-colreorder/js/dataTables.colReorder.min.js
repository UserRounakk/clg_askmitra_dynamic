...
(function (e) {
    ...
    function t(a, b, d) {
        for (var e = [], g = 0, c = a.childNodes.length; g < c; g++)
            1 == a.childNodes[g].nodeType && e.push(a.childNodes[g]);
        b = e[b];
        ...
        if (b != d)
            if (0 > b || b >= i)
                ...
                for (h = a.aoData.length; c < h; c++) {
                    ...
                    "dom" !== l.src && e.isArray(l._aData) && q(l._aData, b, d);
                }
                c = 0;
                ...
                (g || g === s) && e.fn.dataTable.Api(a).rows().invalidate();
                c = 0;
                for (h = i; c < h; c++)
    ...
    e.extend(i.prototype, {
        ...
        fnOrder: function (a, b) {
            ...
            if (b) {
                c = this.fnOrder();
                f = 0;
                for (g = a.length; f < g; f++) d.push(e.inArray(a[f], c));
                a = d;
            }
        ...
        _fnConstruct: function () {
            ...
            if (g)
                if (a.s.dt._bInitComplete)
                    (b = r(g)), a._fnOrderColumns.call(a, b);
                else {
                    var c = !1;
            ...
            for (
                ...
                a: {
                    for (h = c; 0 <= h; ) {
                        ...
                        if (b.s.aoTargets[h + 1].x !== b.s.aoTargets[h].x) {
                            h = b.s.aoTargets[h];
                            break a;
                        }
                    }
                ...
                if (!h)
                    a: {
                        for (h = 0; h < b.s.aoTargets.length - 1; h++)
                            if (b.s.aoTargets[h].x !== b.s.aoTargets[h + 1].x) {
                                h = b.s.aoTargets[h];
                                break a;
                            }
                        h = void 0;
